...
$(function() {
    ...
    pengyouquanTitle = "奔驰EQC 2019M挑战赛，赶快来加入！ ";
    wxtitle = "奔驰EQC 2019M挑战赛，赶快来加入！ ";
    wxdesc = "一路前行，“电力”十足。";
    wxlink = "https://zw.benz.wx.fractalist.com.cn/Game/Index?game=bpeqc";
    wximgUrl = "https://zw.benz.wx.fractalist.com.cn/Games/bpeqc/images/run.jpg";
...
function onloadFun() {
    $.ajax({
        async: false,
        url: 'https://zw.benz.wx.fractalist.com.cn/SystemCommon/GetWeChatJSSDK?urlStr='  + encodeURIComponent(window.location.href.split('#')[0]),
        type: "GET",
        dataType: 'json',
        timeout: 5000,
        beforeSend: function() {},
